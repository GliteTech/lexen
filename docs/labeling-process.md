...
The 363 suspicious Maru 2022 items were reviewed through https://marureview.com/ by professional
lexicographers. The exact reviewer-facing brief is preserved at
`sources/reviews/protocols/marureview-brief-2026-05-26.md`; its SHA-256 hash is
`sha256:fb115149a3518b017f83ee04c3a72710b668fd69c215b1bc021598f6d8d82d80`.

The same brief was used for the three same-protocol reviews:

* Robert Farren, saved 2026-05-26
* Patrick White, saved 2026-05-29
* Penny Hands, saved 2026-06-13

The live `https://marureview.com/brief` page is rendered by the review website. The repository copy
is the stable benchmark reference for citation, verification, and future audits.

Known caveat: the brief asks reviewers to set a confidence rating, but the saved verdict JSON schema
does not include a persisted `confidence` field. The source files preserve the fields that were
actually exported by the review tool: selected sense keys, typed `cannot_answer` flags,
`cannot_answer_notes`, and free-text `comment`.

## Exact Annotator Brief
